      ...
      <p>Please provide some details to create your profile.</p>
        ...
        {hasPreferredCaregiver && (
          <>
            ...
            <input type="text" id="caregiver_name" name="caregiver_name" placeholder="Caregiver's Name" />
          </>
        )}
        ...
        <label>
          <input type="checkbox" name="activity_hangouts" /> Participating in Senior Hangouts
        </label>
        <label>
          <input type="checkbox" name="activity_jogging" /> Following Jogging Guides
        </label>
        <label>
          <input type="checkbox" name="activity_meditation" /> Learning Meditation through Tutorials
        </label>

        <h4>Your Health Journal</h4>
        <p>Provide some information about your health, medications, or any special requirements you have. This will be kept confidential.</p>
        <textarea name="health_journal" placeholder="E.g., Daily medications, allergies, etc." rows="4"></textarea>
